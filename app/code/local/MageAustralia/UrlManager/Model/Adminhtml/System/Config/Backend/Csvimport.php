...
class MageAustralia_UrlManager_Model_Adminhtml_System_Config_Backend_Csvimport extends Mage_Core_Model_Config_Data
{
     ...
     *
     * @return MageAustralia_UrlManager_Model_Adminhtml_System_Config_Backend_Csvimport
     */
    #[\Override]
    protected function _beforeSave()
    {
        ...
        Mage::log('CSV Import: _beforeSave() called', Mage::LOG_DEBUG, 'mageaustralia_urlmanager.log');
        Mage::log('CSV Import: $_FILES data: ' . print_r($_FILES, true), Mage::LOG_DEBUG, 'mageaustralia_urlmanager.log');
        ...
        if (isset($_FILES['groups']['tmp_name'][$this->getGroupId()]['fields'][$this->getField()]['value'])
            ...
            Mage::log('CSV Import: Processing file: ' . $fileName, Mage::LOG_INFO, 'mageaustralia_urlmanager.log');
            Mage::log('CSV Import: Temp file path: ' . $uploadedFile, Mage::LOG_DEBUG, 'mageaustralia_urlmanager.log');
            ...
            try {
                ...
                $skipDuplicates = Mage::getStoreConfigFlag('mageaustralia_urlmanager/csv/skip_duplicates');
                ...
                Mage::log('CSV Import: Import results: ' . print_r($results, true), Mage::LOG_INFO, 'mageaustralia_urlmanager.log');
