 ...
 *
 * Declarative equivalent of the legacy sql/mageaustralia_urlmanager_setup scripts.
...
return function (Schema $schema): void {
    ...
    $redirect = $schema->createTable('mageaustralia_urlmanager_redirect');
    ...
    $log = $schema->createTable('mageaustralia_urlmanager_notfoundlog');
